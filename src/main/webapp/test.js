    ...
    a.prototype.getOffset = function () {
        ...
        _closeOtherSearchInfo: function () {
            ...
            if (!this.dom.panel && f) {
                ...
                e.style.cssText = "display:none;background:#FD9;height:30px;line-height:30px;text-align:center;font-size:112px;color:#994C00;";
                f.appendChild(e);
            ...
            switch (h) {
                ...
                case BMAPLIB_TAB_TO_HERE:
                    ...
                    this.dom.stationText.innerHTML = "start";
